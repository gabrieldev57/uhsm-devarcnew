...
import { OMNIDEF } from './individualEnrollSpinOffProductsUpdateEnglish_def.js';
import tmpl from './individualEnrollSpinOffProductsUpdateEnglish.html';
import tmpl_nds from './individualEnrollSpinOffProductsUpdateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualEnrollSpinOffProductsUpdateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
