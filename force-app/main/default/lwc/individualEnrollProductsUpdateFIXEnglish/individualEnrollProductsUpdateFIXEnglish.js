...
import { OMNIDEF } from './individualEnrollProductsUpdateFIXEnglish_def.js';
import tmpl from './individualEnrollProductsUpdateFIXEnglish.html';
import tmpl_nds from './individualEnrollProductsUpdateFIXEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualEnrollProductsUpdateFIXEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
