...
import { OMNIDEF } from './individualShopProductsUpdateSpinOffEnglish_def.js';
import tmpl from './individualShopProductsUpdateSpinOffEnglish.html';
import tmpl_nds from './individualShopProductsUpdateSpinOffEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualShopProductsUpdateSpinOffEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
