import { _calculateAgeFromBirthdate, _isNewbornMember } from "./aRC_FormCensusUtilities";
...
export function validateRequiredFields(field_name, member, member_index) {
    ...
    console.log(' memberRequiredFields --> ' + JSON.stringify(member))

    const isWeightHeightField = field_name === 'ARC_Weight__c' || field_name === 'ARC_HeightInches__c' || field_name === 'ARC_HeightFeet__c';

    if(member['IsRemoveMember'] == true || (member['IsNewMember'] == false && isWeightHeightField) ){
        console.log(' memberRequiredFields IN' )
        return null;
    }
