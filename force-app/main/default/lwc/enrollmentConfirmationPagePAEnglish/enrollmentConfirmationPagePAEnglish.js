...
import { OMNIDEF } from './enrollmentConfirmationPagePAEnglish_def.js';
import tmpl from './enrollmentConfirmationPagePAEnglish.html';
import tmpl_nds from './enrollmentConfirmationPagePAEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class enrollmentConfirmationPagePAEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
