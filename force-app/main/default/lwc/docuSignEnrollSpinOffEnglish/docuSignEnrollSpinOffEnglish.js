...
import { OMNIDEF } from './docuSignEnrollSpinOffEnglish_def.js';
import tmpl from './docuSignEnrollSpinOffEnglish.html';
import tmpl_nds from './docuSignEnrollSpinOffEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class docuSignEnrollSpinOffEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
