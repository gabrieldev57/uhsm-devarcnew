...
import { OMNIDEF } from './personAccountExternalInsuranceEnglish_def.js';
import tmpl from './personAccountExternalInsuranceEnglish.html';
import tmpl_nds from './personAccountExternalInsuranceEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class personAccountExternalInsuranceEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
