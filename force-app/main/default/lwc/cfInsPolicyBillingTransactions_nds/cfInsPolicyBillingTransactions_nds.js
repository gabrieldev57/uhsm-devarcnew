import { FlexCardMixin } from "vlocity_ins/flexCardMixin";
    ...
    import { load } from "vlocity_ins/newportLoader";
          ...
          export default class cfInsPolicyBillingTransactions_nds extends FlexCardMixin(LightningElement){
 ...
 this.registerEvents();
            ...
            this.customEventName0 = interpolateWithRegex(`add`,this._allMergeFields,this._regexPattern,"noparse");
