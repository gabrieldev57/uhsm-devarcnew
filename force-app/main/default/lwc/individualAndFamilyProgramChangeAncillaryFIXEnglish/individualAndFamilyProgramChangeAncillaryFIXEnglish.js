...
import { OMNIDEF } from './individualAndFamilyProgramChangeAncillaryFIXEnglish_def.js';
import tmpl from './individualAndFamilyProgramChangeAncillaryFIXEnglish.html';
import tmpl_nds from './individualAndFamilyProgramChangeAncillaryFIXEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualAndFamilyProgramChangeAncillaryFIXEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
