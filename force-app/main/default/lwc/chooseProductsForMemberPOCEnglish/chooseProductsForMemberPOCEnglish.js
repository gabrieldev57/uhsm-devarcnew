...
import { OMNIDEF } from './chooseProductsForMemberPOCEnglish_def.js';
import tmpl from './chooseProductsForMemberPOCEnglish.html';
import tmpl_nds from './chooseProductsForMemberPOCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class chooseProductsForMemberPOCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
