...
import { OMNIDEF } from './docGenerationReceiptsEnglish_def.js';
import tmpl from './docGenerationReceiptsEnglish.html';
import tmpl_nds from './docGenerationReceiptsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class docGenerationReceiptsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
