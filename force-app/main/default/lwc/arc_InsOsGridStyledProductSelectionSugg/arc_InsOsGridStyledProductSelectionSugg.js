...
import template from './arc_InsOsGridStyledProductSelectionSugg.html';
const MAX_CONCURRENT_SERVICE_REQUEST = 5;


export default class arc_InsOsGridStyledProductSelectionSugg extends insOsGridProductSelectionSugg {

    @api customClass; // Added to set a custom class on the main container to apply different styles to the components.
    // productsByGroup = [
    //     {
    //         groupName: 'Medal',
    //         uniqueAttributes: [
    ...
    */
    ...
    renderedCallback() {
        let mainContainer = this.template.querySelector(".iogspss-main-container")
        if(mainContainer) mainContainer.classList.add(this.customClass)
