...
import { OMNIDEF } from './individualAndFamilyFelipeProgramChangeEnglish_def.js';
import tmpl from './individualAndFamilyFelipeProgramChangeEnglish.html';
import tmpl_nds from './individualAndFamilyFelipeProgramChangeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualAndFamilyFelipeProgramChangeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
