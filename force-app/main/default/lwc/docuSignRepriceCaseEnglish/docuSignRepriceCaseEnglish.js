...
import { OMNIDEF } from './docuSignRepriceCaseEnglish_def.js';
import tmpl from './docuSignRepriceCaseEnglish.html';
import tmpl_nds from './docuSignRepriceCaseEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class docuSignRepriceCaseEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
