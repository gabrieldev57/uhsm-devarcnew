...
import { OMNIDEF } from './testingPcLWCTestAgustinaEnglish_def.js';
import tmpl from './testingPcLWCTestAgustinaEnglish.html';
import tmpl_nds from './testingPcLWCTestAgustinaEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class testingPcLWCTestAgustinaEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
