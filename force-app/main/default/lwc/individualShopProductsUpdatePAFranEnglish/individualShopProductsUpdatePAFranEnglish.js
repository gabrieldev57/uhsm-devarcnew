...
import { OMNIDEF } from './individualShopProductsUpdatePAFranEnglish_def.js';
import tmpl from './individualShopProductsUpdatePAFranEnglish.html';
import tmpl_nds from './individualShopProductsUpdatePAFranEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualShopProductsUpdatePAFranEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
