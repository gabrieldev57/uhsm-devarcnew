...
import { OMNIDEF } from './individualAndFamilyAddTemporaryNewbornEnglish_def.js';
import tmpl from './individualAndFamilyAddTemporaryNewbornEnglish.html';
import tmpl_nds from './individualAndFamilyAddTemporaryNewbornEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualAndFamilyAddTemporaryNewbornEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
