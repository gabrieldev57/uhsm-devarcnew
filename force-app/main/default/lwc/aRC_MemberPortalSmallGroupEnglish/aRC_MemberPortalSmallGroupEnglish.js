...
import { OMNIDEF } from './aRC_MemberPortalSmallGroupEnglish_def.js';
import tmpl from './aRC_MemberPortalSmallGroupEnglish.html';
import tmpl_nds from './aRC_MemberPortalSmallGroupEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aRC_MemberPortalSmallGroupEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
