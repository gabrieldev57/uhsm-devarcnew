...
import { OMNIDEF } from './aRC_MemberPortalMemberCardEnglish_def.js';
import tmpl from './aRC_MemberPortalMemberCardEnglish.html';
import tmpl_nds from './aRC_MemberPortalMemberCardEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aRC_MemberPortalMemberCardEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
