...
import { OMNIDEF } from './docuSignUnderwritingCaseEnglish_def.js';
import tmpl from './docuSignUnderwritingCaseEnglish.html';
import tmpl_nds from './docuSignUnderwritingCaseEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class docuSignUnderwritingCaseEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
