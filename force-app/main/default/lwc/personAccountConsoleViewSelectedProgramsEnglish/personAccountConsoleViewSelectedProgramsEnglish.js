...
import { OMNIDEF } from './personAccountConsoleViewSelectedProgramsEnglish_def.js';
import tmpl from './personAccountConsoleViewSelectedProgramsEnglish.html';
import tmpl_nds from './personAccountConsoleViewSelectedProgramsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class personAccountConsoleViewSelectedProgramsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
