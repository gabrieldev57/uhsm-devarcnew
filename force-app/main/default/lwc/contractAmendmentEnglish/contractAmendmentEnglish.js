...
import { OMNIDEF } from './contractAmendmentEnglish_def.js';
import tmpl from './contractAmendmentEnglish.html';
import tmpl_nds from './contractAmendmentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class contractAmendmentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
