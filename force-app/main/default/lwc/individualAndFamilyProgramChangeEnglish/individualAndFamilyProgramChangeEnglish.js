...
import { OMNIDEF } from './individualAndFamilyProgramChangeEnglish_def.js';
import tmpl from './individualAndFamilyProgramChangeEnglish.html';
import tmpl_nds from './individualAndFamilyProgramChangeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualAndFamilyProgramChangeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
