...
import { OMNIDEF } from './programChangeInsOsCensusEnglish_def.js';
import tmpl from './programChangeInsOsCensusEnglish.html';
import tmpl_nds from './programChangeInsOsCensusEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class programChangeInsOsCensusEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
