...
import { OMNIDEF } from './programChange_eFFECTIVEpocFelipeEnglish_def.js';
import tmpl from './programChange_eFFECTIVEpocFelipeEnglish.html';
import tmpl_nds from './programChange_eFFECTIVEpocFelipeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class programChange_eFFECTIVEpocFelipeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
