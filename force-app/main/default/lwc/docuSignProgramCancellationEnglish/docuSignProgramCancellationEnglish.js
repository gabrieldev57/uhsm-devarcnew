...
import { OMNIDEF } from './docuSignProgramCancellationEnglish_def.js';
import tmpl from './docuSignProgramCancellationEnglish.html';
import tmpl_nds from './docuSignProgramCancellationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class docuSignProgramCancellationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
