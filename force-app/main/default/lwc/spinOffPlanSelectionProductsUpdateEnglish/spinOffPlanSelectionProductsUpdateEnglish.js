...
import { OMNIDEF } from './spinOffPlanSelectionProductsUpdateEnglish_def.js';
import tmpl from './spinOffPlanSelectionProductsUpdateEnglish.html';
import tmpl_nds from './spinOffPlanSelectionProductsUpdateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class spinOffPlanSelectionProductsUpdateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
