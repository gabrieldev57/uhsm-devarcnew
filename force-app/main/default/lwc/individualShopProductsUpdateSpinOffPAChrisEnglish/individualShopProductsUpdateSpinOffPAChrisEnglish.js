...
import { OMNIDEF } from './individualShopProductsUpdateSpinOffPAChrisEnglish_def.js';
import tmpl from './individualShopProductsUpdateSpinOffPAChrisEnglish.html';
import tmpl_nds from './individualShopProductsUpdateSpinOffPAChrisEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualShopProductsUpdateSpinOffPAChrisEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
