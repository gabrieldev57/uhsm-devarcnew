...
import { OMNIDEF } from './iFPEnrollmentPlanSelectionProductsUpdateFrancoEnglish_def.js';
import tmpl from './iFPEnrollmentPlanSelectionProductsUpdateFrancoEnglish.html';
import tmpl_nds from './iFPEnrollmentPlanSelectionProductsUpdateFrancoEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class iFPEnrollmentPlanSelectionProductsUpdateFrancoEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
