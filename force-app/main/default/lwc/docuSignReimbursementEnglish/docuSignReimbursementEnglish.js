...
import { OMNIDEF } from './docuSignReimbursementEnglish_def.js';
import tmpl from './docuSignReimbursementEnglish.html';
import tmpl_nds from './docuSignReimbursementEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class docuSignReimbursementEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
