...
import { OMNIDEF } from './individualAndFamilyRepriceCasePAEnglish_def.js';
import tmpl from './individualAndFamilyRepriceCasePAEnglish.html';
import tmpl_nds from './individualAndFamilyRepriceCasePAEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualAndFamilyRepriceCasePAEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
