...
import { OMNIDEF } from './individualShopProductsUpdatePAEnglish_def.js';
import tmpl from './individualShopProductsUpdatePAEnglish.html';
import tmpl_nds from './individualShopProductsUpdatePAEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualShopProductsUpdatePAEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
