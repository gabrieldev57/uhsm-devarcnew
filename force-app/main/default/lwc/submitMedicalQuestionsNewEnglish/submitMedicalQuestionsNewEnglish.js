...
import { OMNIDEF } from './submitMedicalQuestionsNewEnglish_def.js';
import tmpl from './submitMedicalQuestionsNewEnglish.html';
import tmpl_nds from './submitMedicalQuestionsNewEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class submitMedicalQuestionsNewEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
