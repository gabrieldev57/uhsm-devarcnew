...
import { OMNIDEF } from './individualEnrollProductsUpdatePAFrancoEnglish_def.js';
import tmpl from './individualEnrollProductsUpdatePAFrancoEnglish.html';
import tmpl_nds from './individualEnrollProductsUpdatePAFrancoEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualEnrollProductsUpdatePAFrancoEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
