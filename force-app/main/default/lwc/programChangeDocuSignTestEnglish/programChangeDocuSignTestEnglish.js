...
import { OMNIDEF } from './programChangeDocuSignTestEnglish_def.js';
import tmpl from './programChangeDocuSignTestEnglish.html';
import tmpl_nds from './programChangeDocuSignTestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class programChangeDocuSignTestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
