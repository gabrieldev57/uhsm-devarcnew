...
import { OMNIDEF } from './paymentApplicationEnglish_def.js';
import tmpl from './paymentApplicationEnglish.html';
import tmpl_nds from './paymentApplicationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class paymentApplicationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
