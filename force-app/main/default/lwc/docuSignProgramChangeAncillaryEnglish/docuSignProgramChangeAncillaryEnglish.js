...
import { OMNIDEF } from './docuSignProgramChangeAncillaryEnglish_def.js';
import tmpl from './docuSignProgramChangeAncillaryEnglish.html';
import tmpl_nds from './docuSignProgramChangeAncillaryEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class docuSignProgramChangeAncillaryEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
