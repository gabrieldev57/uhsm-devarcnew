...
import { OMNIDEF } from './healthyDiscountDiscountEnglish_def.js';
import tmpl from './healthyDiscountDiscountEnglish.html';
import tmpl_nds from './healthyDiscountDiscountEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class healthyDiscountDiscountEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
