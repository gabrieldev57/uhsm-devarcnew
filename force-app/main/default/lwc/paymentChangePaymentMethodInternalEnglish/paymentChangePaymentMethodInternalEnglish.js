...
import { OMNIDEF } from './paymentChangePaymentMethodInternalEnglish_def.js';
import tmpl from './paymentChangePaymentMethodInternalEnglish.html';
import tmpl_nds from './paymentChangePaymentMethodInternalEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class paymentChangePaymentMethodInternalEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
