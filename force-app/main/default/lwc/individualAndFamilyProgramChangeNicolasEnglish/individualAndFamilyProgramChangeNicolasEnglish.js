...
import { OMNIDEF } from './individualAndFamilyProgramChangeNicolasEnglish_def.js';
import tmpl from './individualAndFamilyProgramChangeNicolasEnglish.html';
import tmpl_nds from './individualAndFamilyProgramChangeNicolasEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualAndFamilyProgramChangeNicolasEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
