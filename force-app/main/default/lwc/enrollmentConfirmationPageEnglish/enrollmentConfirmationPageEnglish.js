...
import { OMNIDEF } from './enrollmentConfirmationPageEnglish_def.js';
import tmpl from './enrollmentConfirmationPageEnglish.html';
import tmpl_nds from './enrollmentConfirmationPageEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class enrollmentConfirmationPageEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
