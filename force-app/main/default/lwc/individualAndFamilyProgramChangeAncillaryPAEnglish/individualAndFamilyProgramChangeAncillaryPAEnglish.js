...
import { OMNIDEF } from './individualAndFamilyProgramChangeAncillaryPAEnglish_def.js';
import tmpl from './individualAndFamilyProgramChangeAncillaryPAEnglish.html';
import tmpl_nds from './individualAndFamilyProgramChangeAncillaryPAEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualAndFamilyProgramChangeAncillaryPAEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
