...
import { OMNIDEF } from './programChangeChooseProductSelectionEnglish_def.js';
import tmpl from './programChangeChooseProductSelectionEnglish.html';
import tmpl_nds from './programChangeChooseProductSelectionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class programChangeChooseProductSelectionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
