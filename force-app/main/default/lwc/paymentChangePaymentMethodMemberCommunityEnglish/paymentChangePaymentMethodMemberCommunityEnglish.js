...
import { OMNIDEF } from './paymentChangePaymentMethodMemberCommunityEnglish_def.js';
import tmpl from './paymentChangePaymentMethodMemberCommunityEnglish.html';
import tmpl_nds from './paymentChangePaymentMethodMemberCommunityEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class paymentChangePaymentMethodMemberCommunityEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
