...
import { OMNIDEF } from './healthyDiscountForPersonAccountHealthyDiscountEnglish_def.js';
import tmpl from './healthyDiscountForPersonAccountHealthyDiscountEnglish.html';
import tmpl_nds from './healthyDiscountForPersonAccountHealthyDiscountEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class healthyDiscountForPersonAccountHealthyDiscountEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
