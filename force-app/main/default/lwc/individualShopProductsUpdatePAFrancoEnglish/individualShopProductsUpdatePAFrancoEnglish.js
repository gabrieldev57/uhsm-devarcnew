...
import { OMNIDEF } from './individualShopProductsUpdatePAFrancoEnglish_def.js';
import tmpl from './individualShopProductsUpdatePAFrancoEnglish.html';
import tmpl_nds from './individualShopProductsUpdatePAFrancoEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualShopProductsUpdatePAFrancoEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
