...
import { OMNIDEF } from './individualEnrollSpinOffProductsUpdatePAEnglish_def.js';
import tmpl from './individualEnrollSpinOffProductsUpdatePAEnglish.html';
import tmpl_nds from './individualEnrollSpinOffProductsUpdatePAEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualEnrollSpinOffProductsUpdatePAEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
