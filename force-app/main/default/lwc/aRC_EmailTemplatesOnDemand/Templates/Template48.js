//Healthy discount 90 days out
import { Signature } from "./Signature";

export function Template48(FirstName,ExpirationDate,imageURLs) {
    return `
    <p style="margin-bottom:8.0pt;line-height:15px;">Dear ${FirstName},</p>
    <p>Let’s keep the savings going!</p><br>
    <p><p>Your Healthy Discount is approaching its annual expiration date, ${ExpirationDate}. To be considered for this monthly contribution discount for the next year. </p> </p><br>
