...
//Age Off 60
export function Template45(FirstName,OldestMemberName,OldestMemberBirthdate,MonthlyContribution,AgesUpDraftDate,NextContributionInSixtyDays,imageURLs) {
    let body = '';
    body += '<p style="margin-bottom:8.0pt;line-height:15px;">Hello ' + FirstName + ',</p><br>';
    body += '<p><p>As part of your WeShare membership, we’re notifying you of an upcoming change to your monthly sharing amount due to '+ OldestMemberName +' birthday on '+ OldestMemberBirthdate +', moving your membership into a new age bracket. <span style="font-weight:bold;">There is no action required on your part.</span></p><br>';
