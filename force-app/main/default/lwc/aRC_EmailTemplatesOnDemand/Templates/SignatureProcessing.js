export function SignatureProcessing(imageURLs) {
    ...
    signature += '	<tbody>';
    signature += '		<tr>';
    signature += '			<td rowspan="4" style="width: 26.1868%;border-right: 2px solid #cdd0d4; Padding: 10px;">';
    ...
    signature += '		<tr>';
    signature += '			<td style="width:178.1pt;padding:0in 5.4pt 0in 5.4pt;">';
    signature += '				<a href="mailto:processing@weshare.org">processing@weshare.org</a>';
    signature += '			</td>';
    signature += '			<td style="width:178.1pt;padding:0in 5.4pt 0in 5.4pt;">';
