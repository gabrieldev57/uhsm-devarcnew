...
export function Template55(FirstName, imageURLs) {
    ...
    body += '    <li style="margin: 10px 0;">Schedule an appointment with your closest LabCorp.'
    ...
    body += '    <li style="margin: 10px 0;"><b>Do not</b> use your WeShare ID for billing. Please ensure that LabCorp bills to the account listed on the lab order.</li>'
