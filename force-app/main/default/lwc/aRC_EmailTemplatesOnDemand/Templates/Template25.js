...
//UHSM (A.I.D.D) Initial Payment Decline (from UHSM) – sent when only the AIDD Declines for payment.
export function Template25(FirstName, AiddPlanName, NextTransactionDate, imageURLs) {
    let body = '';
    ...
    body += '<p style="margin-right:0in;margin-left:0in;margin-top:0in;margin-bottom:8.0pt;line-height:107%;"><strong>Program</strong><strong>:</strong> ' + AiddPlanName + '</p>';
    body += '<p style="margin-right:0in;margin-left:0in;margin-top:0in;margin-bottom:8.0pt;line-height:107%;"><strong>Contribution Due:</strong> ' + NextTransactionDate + '</p>';
    ...
    body += '<p style="margin-right:0in;margin-left:0in;margin-top:0in;margin-bottom:8.0pt;line-height:107%;">A charge can be declined for a variety of reasons. For more information on why the charge was declined, please contact your bank or the bank that issued your card.</p>';
