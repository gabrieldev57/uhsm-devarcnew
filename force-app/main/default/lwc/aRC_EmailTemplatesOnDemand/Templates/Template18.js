...
//Approval Resend
export function Template18(FirstName, PrimaryName, CountOfDependents, MedicalPlanName, MemberID, ContractEffectiveDate, OldMonthlyContribution, InitialContribution, ChargeDate, imageURLs) {
    let body = '';
    ...
    body += '<p style="margin-top:0in;margin-right:0in;margin-bottom:0in;margin-left:0in;line-height:normal;"><span style="color:black;">Please see below for important details of your WeShare membership:</span></p>';
    ...
    body += '			</td>';
    body += '			<td style="width: 292.5pt;border-top: none;border-bottom: none;border-left: none;border-image: initial;border-right: 1pt solid windowtext;padding: 0in 5.4pt;vertical-align: top;">';
    body += '				<p style="margin-top:0in;margin-right:0in;margin-bottom:0in;margin-left:0in;line-height:normal;"><span>$' + OldMonthlyContribution + '</span></p>';
    body += '			</td>';
    body += '		</tr>';
    body += '		<tr>';
    body += '			<td style="width: 157.25pt;border-top: 1pt solid windowtext;border-bottom: 1pt solid windowtext;border-left: 1pt solid windowtext;border-image: initial;border-right: none;background: white;padding: 0in 5.4pt;vertical-align: top;">';
