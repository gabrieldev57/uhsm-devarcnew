...
import { OMNIDEF } from './individualAndFamilySpinOffEnglish_def.js';
import tmpl from './individualAndFamilySpinOffEnglish.html';
import tmpl_nds from './individualAndFamilySpinOffEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualAndFamilySpinOffEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
