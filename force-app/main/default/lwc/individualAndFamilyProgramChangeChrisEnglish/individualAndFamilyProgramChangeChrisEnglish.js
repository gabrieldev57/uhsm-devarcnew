...
import { OMNIDEF } from './individualAndFamilyProgramChangeChrisEnglish_def.js';
import tmpl from './individualAndFamilyProgramChangeChrisEnglish.html';
import tmpl_nds from './individualAndFamilyProgramChangeChrisEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualAndFamilyProgramChangeChrisEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
