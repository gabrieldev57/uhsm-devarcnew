...
import { OMNIDEF } from './individualAndFamilyProgramChangeSantiEnglish_def.js';
import tmpl from './individualAndFamilyProgramChangeSantiEnglish.html';
import tmpl_nds from './individualAndFamilyProgramChangeSantiEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualAndFamilyProgramChangeSantiEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
