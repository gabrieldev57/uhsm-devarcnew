...
import { OMNIDEF } from './programChangeDocuSignEnglish_def.js';
import tmpl from './programChangeDocuSignEnglish.html';
import tmpl_nds from './programChangeDocuSignEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class programChangeDocuSignEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
