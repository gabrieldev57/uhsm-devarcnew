...
import { OMNIDEF } from './pCNicoEnglish_def.js';
import tmpl from './pCNicoEnglish.html';
import tmpl_nds from './pCNicoEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class pCNicoEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
