...
import { OMNIDEF } from './individualEnrollProductsUpdatePAEnglish_def.js';
import tmpl from './individualEnrollProductsUpdatePAEnglish.html';
import tmpl_nds from './individualEnrollProductsUpdatePAEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualEnrollProductsUpdatePAEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
