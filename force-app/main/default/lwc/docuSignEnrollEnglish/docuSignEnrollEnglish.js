...
import { OMNIDEF } from './docuSignEnrollEnglish_def.js';
import tmpl from './docuSignEnrollEnglish.html';
import tmpl_nds from './docuSignEnrollEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class docuSignEnrollEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
