...
import { OMNIDEF } from './programChangeInsOsGridProductSelectionEnglish_def.js';
import tmpl from './programChangeInsOsGridProductSelectionEnglish.html';
import tmpl_nds from './programChangeInsOsGridProductSelectionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class programChangeInsOsGridProductSelectionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
