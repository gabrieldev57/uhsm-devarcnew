...
import { OMNIDEF } from './singleSpinOffChooseProdcutSelectionEnglish_def.js';
import tmpl from './singleSpinOffChooseProdcutSelectionEnglish.html';
import tmpl_nds from './singleSpinOffChooseProdcutSelectionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class singleSpinOffChooseProdcutSelectionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
