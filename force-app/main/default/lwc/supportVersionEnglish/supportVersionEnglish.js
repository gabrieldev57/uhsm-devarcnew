...
import { OMNIDEF } from './supportVersionEnglish_def.js';
import tmpl from './supportVersionEnglish.html';
import tmpl_nds from './supportVersionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class supportVersionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
