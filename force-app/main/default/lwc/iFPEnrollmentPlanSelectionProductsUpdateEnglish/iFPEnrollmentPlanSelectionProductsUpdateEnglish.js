...
import { OMNIDEF } from './iFPEnrollmentPlanSelectionProductsUpdateEnglish_def.js';
import tmpl from './iFPEnrollmentPlanSelectionProductsUpdateEnglish.html';
import tmpl_nds from './iFPEnrollmentPlanSelectionProductsUpdateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class iFPEnrollmentPlanSelectionProductsUpdateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
