...
import { OMNIDEF } from './individualAndFamilyProgramChangeMPEnglish_def.js';
import tmpl from './individualAndFamilyProgramChangeMPEnglish.html';
import tmpl_nds from './individualAndFamilyProgramChangeMPEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualAndFamilyProgramChangeMPEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
