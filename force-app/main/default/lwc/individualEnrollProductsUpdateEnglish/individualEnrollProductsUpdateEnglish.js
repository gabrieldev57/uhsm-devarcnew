...
import { OMNIDEF } from './individualEnrollProductsUpdateEnglish_def.js';
import tmpl from './individualEnrollProductsUpdateEnglish.html';
import tmpl_nds from './individualEnrollProductsUpdateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualEnrollProductsUpdateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
