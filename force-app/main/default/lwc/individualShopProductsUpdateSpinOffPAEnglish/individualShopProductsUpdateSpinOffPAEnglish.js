...
import { OMNIDEF } from './individualShopProductsUpdateSpinOffPAEnglish_def.js';
import tmpl from './individualShopProductsUpdateSpinOffPAEnglish.html';
import tmpl_nds from './individualShopProductsUpdateSpinOffPAEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualShopProductsUpdateSpinOffPAEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
