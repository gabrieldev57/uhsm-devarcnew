...
import { OMNIDEF } from './individualEnrollTestTestEnglish_def.js';
import tmpl from './individualEnrollTestTestEnglish.html';
import tmpl_nds from './individualEnrollTestTestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualEnrollTestTestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
