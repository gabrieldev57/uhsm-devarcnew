...
import { OMNIDEF } from './docuSignResendReimbursementEnglish_def.js';
import tmpl from './docuSignResendReimbursementEnglish.html';
import tmpl_nds from './docuSignResendReimbursementEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class docuSignResendReimbursementEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
