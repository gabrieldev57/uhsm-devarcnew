...
import { OMNIDEF } from './individualAndFamilySpinOffGaboEnglish_def.js';
import tmpl from './individualAndFamilySpinOffGaboEnglish.html';
import tmpl_nds from './individualAndFamilySpinOffGaboEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualAndFamilySpinOffGaboEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
