...
import { OMNIDEF } from './submitMedicalQuestionsEnglish_def.js';
import tmpl from './submitMedicalQuestionsEnglish.html';
import tmpl_nds from './submitMedicalQuestionsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class submitMedicalQuestionsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
