...
import { OMNIDEF } from './iFPEnrollmentPlanSelectionProductsUpdateCHRISEnglish_def.js';
import tmpl from './iFPEnrollmentPlanSelectionProductsUpdateCHRISEnglish.html';
import tmpl_nds from './iFPEnrollmentPlanSelectionProductsUpdateCHRISEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class iFPEnrollmentPlanSelectionProductsUpdateCHRISEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
