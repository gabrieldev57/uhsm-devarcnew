...
import { OMNIDEF } from './individualAndFamilyProgramChangeTOMASEnglish_def.js';
import tmpl from './individualAndFamilyProgramChangeTOMASEnglish.html';
import tmpl_nds from './individualAndFamilyProgramChangeTOMASEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualAndFamilyProgramChangeTOMASEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
