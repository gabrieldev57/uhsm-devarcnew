...
import { OMNIDEF } from './individualAndFamilyPOCSaveForLaterPOCEnglish_def.js';
import tmpl from './individualAndFamilyPOCSaveForLaterPOCEnglish.html';
import tmpl_nds from './individualAndFamilyPOCSaveForLaterPOCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualAndFamilyPOCSaveForLaterPOCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
