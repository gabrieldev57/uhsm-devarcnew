...
import { OMNIDEF } from './chooseProductsForMemberEnglish_def.js';
import tmpl from './chooseProductsForMemberEnglish.html';
import tmpl_nds from './chooseProductsForMemberEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class chooseProductsForMemberEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
