...
import { OMNIDEF } from './individualAndFamilyFelipeProgramChangeFelipeEnglish_def.js';
import tmpl from './individualAndFamilyFelipeProgramChangeFelipeEnglish.html';
import tmpl_nds from './individualAndFamilyFelipeProgramChangeFelipeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualAndFamilyFelipeProgramChangeFelipeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
