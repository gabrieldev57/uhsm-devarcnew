...
import { OMNIDEF } from './individualAndFamilyAddTemporaryNewbornAgustinaEnglish_def.js';
import tmpl from './individualAndFamilyAddTemporaryNewbornAgustinaEnglish.html';
import tmpl_nds from './individualAndFamilyAddTemporaryNewbornAgustinaEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualAndFamilyAddTemporaryNewbornAgustinaEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
