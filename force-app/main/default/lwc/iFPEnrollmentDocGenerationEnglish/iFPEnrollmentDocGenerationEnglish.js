...
import { OMNIDEF } from './iFPEnrollmentDocGenerationEnglish_def.js';
import tmpl from './iFPEnrollmentDocGenerationEnglish.html';
import tmpl_nds from './iFPEnrollmentDocGenerationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class iFPEnrollmentDocGenerationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
