...
import { OMNIDEF } from './individualAndFamilyProgramChangeAncillaryEnglish_def.js';
import tmpl from './individualAndFamilyProgramChangeAncillaryEnglish.html';
import tmpl_nds from './individualAndFamilyProgramChangeAncillaryEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualAndFamilyProgramChangeAncillaryEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
