...
import { OMNIDEF } from './consoleViewSelectedProgramsEnglish_def.js';
import tmpl from './consoleViewSelectedProgramsEnglish.html';
import tmpl_nds from './consoleViewSelectedProgramsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class consoleViewSelectedProgramsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
