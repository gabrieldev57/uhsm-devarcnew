...
import { OMNIDEF } from './individualAndFamilyPCSpinOffEnglish_def.js';
import tmpl from './individualAndFamilyPCSpinOffEnglish.html';
import tmpl_nds from './individualAndFamilyPCSpinOffEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualAndFamilyPCSpinOffEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
