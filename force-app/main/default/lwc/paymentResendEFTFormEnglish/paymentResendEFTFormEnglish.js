...
import { OMNIDEF } from './paymentResendEFTFormEnglish_def.js';
import tmpl from './paymentResendEFTFormEnglish.html';
import tmpl_nds from './paymentResendEFTFormEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class paymentResendEFTFormEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
