...
import { OMNIDEF } from './individualAndFamilyProgramChangeGaryEnglish_def.js';
import tmpl from './individualAndFamilyProgramChangeGaryEnglish.html';
import tmpl_nds from './individualAndFamilyProgramChangeGaryEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualAndFamilyProgramChangeGaryEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
