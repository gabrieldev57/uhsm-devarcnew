...
import { OMNIDEF } from './programChangeInsOsGridProductSelectionMPEnglish_def.js';
import tmpl from './programChangeInsOsGridProductSelectionMPEnglish.html';
import tmpl_nds from './programChangeInsOsGridProductSelectionMPEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class programChangeInsOsGridProductSelectionMPEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
