...
import { OMNIDEF } from './individualAndFamilyPOCFelipeEnglish_def.js';
import tmpl from './individualAndFamilyPOCFelipeEnglish.html';
import tmpl_nds from './individualAndFamilyPOCFelipeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualAndFamilyPOCFelipeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
