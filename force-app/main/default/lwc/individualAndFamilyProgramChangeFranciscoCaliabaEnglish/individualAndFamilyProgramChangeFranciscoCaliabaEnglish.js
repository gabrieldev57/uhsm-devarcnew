...
import { OMNIDEF } from './individualAndFamilyProgramChangeFranciscoCaliabaEnglish_def.js';
import tmpl from './individualAndFamilyProgramChangeFranciscoCaliabaEnglish.html';
import tmpl_nds from './individualAndFamilyProgramChangeFranciscoCaliabaEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualAndFamilyProgramChangeFranciscoCaliabaEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
