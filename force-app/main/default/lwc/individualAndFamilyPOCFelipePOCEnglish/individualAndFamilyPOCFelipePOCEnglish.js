...
import { OMNIDEF } from './individualAndFamilyPOCFelipePOCEnglish_def.js';
import tmpl from './individualAndFamilyPOCFelipePOCEnglish.html';
import tmpl_nds from './individualAndFamilyPOCFelipePOCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualAndFamilyPOCFelipePOCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
