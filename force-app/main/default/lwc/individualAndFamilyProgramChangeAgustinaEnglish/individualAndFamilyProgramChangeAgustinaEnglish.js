...
import { OMNIDEF } from './individualAndFamilyProgramChangeAgustinaEnglish_def.js';
import tmpl from './individualAndFamilyProgramChangeAgustinaEnglish.html';
import tmpl_nds from './individualAndFamilyProgramChangeAgustinaEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualAndFamilyProgramChangeAgustinaEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
