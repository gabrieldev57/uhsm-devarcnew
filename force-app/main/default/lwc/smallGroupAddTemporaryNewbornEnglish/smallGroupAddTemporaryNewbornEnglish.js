...
import { OMNIDEF } from './smallGroupAddTemporaryNewbornEnglish_def.js';
import tmpl from './smallGroupAddTemporaryNewbornEnglish.html';
import tmpl_nds from './smallGroupAddTemporaryNewbornEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class smallGroupAddTemporaryNewbornEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
