...
import { OMNIDEF } from './programChangeInsOsGridProductSelectionCHRISEnglish_def.js';
import tmpl from './programChangeInsOsGridProductSelectionCHRISEnglish.html';
import tmpl_nds from './programChangeInsOsGridProductSelectionCHRISEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class programChangeInsOsGridProductSelectionCHRISEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
