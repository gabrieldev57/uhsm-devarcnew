...
import { OMNIDEF } from './healthyDiscountApplyDiscountEnglish_def.js';
import tmpl from './healthyDiscountApplyDiscountEnglish.html';
import tmpl_nds from './healthyDiscountApplyDiscountEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class healthyDiscountApplyDiscountEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
