...
import { OMNIDEF } from './individualShopProductsUpdateEnglish_def.js';
import tmpl from './individualShopProductsUpdateEnglish.html';
import tmpl_nds from './individualShopProductsUpdateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualShopProductsUpdateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
