...
import { OMNIDEF } from './testTestfranEnglish_def.js';
import tmpl from './testTestfranEnglish.html';
import tmpl_nds from './testTestfranEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class testTestfranEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
