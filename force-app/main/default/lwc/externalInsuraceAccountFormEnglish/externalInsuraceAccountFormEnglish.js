...
import { OMNIDEF } from './externalInsuraceAccountFormEnglish_def.js';
import tmpl from './externalInsuraceAccountFormEnglish.html';
import tmpl_nds from './externalInsuraceAccountFormEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class externalInsuraceAccountFormEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
