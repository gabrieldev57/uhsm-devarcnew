...
import { OMNIDEF } from './censusCensusUploadGuestUserEnglish_def.js';
import tmpl from './censusCensusUploadGuestUserEnglish.html';
import tmpl_nds from './censusCensusUploadGuestUserEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class censusCensusUploadGuestUserEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
