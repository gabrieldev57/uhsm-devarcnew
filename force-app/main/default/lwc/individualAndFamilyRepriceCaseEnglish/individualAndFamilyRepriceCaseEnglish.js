...
import { OMNIDEF } from './individualAndFamilyRepriceCaseEnglish_def.js';
import tmpl from './individualAndFamilyRepriceCaseEnglish.html';
import tmpl_nds from './individualAndFamilyRepriceCaseEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualAndFamilyRepriceCaseEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
