...
import { OMNIDEF } from './iFPEnrollmentApplicationGuestUserEnglish_def.js';
import tmpl from './iFPEnrollmentApplicationGuestUserEnglish.html';
import tmpl_nds from './iFPEnrollmentApplicationGuestUserEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class iFPEnrollmentApplicationGuestUserEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
