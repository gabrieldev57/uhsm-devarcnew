...
import { OMNIDEF } from './docuSignAmendmentEnglish_def.js';
import tmpl from './docuSignAmendmentEnglish.html';
import tmpl_nds from './docuSignAmendmentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class docuSignAmendmentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
