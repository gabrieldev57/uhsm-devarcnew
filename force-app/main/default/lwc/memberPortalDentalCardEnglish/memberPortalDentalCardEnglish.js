...
import { OMNIDEF } from './memberPortalDentalCardEnglish_def.js';
import tmpl from './memberPortalDentalCardEnglish.html';
import tmpl_nds from './memberPortalDentalCardEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class memberPortalDentalCardEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
