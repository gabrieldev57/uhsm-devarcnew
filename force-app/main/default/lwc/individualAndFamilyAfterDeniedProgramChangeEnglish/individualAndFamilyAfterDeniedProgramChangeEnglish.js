...
import { OMNIDEF } from './individualAndFamilyAfterDeniedProgramChangeEnglish_def.js';
import tmpl from './individualAndFamilyAfterDeniedProgramChangeEnglish.html';
import tmpl_nds from './individualAndFamilyAfterDeniedProgramChangeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualAndFamilyAfterDeniedProgramChangeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
