...
import { OMNIDEF } from './individualAndFamilyProgramChangeGaboEnglish_def.js';
import tmpl from './individualAndFamilyProgramChangeGaboEnglish.html';
import tmpl_nds from './individualAndFamilyProgramChangeGaboEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualAndFamilyProgramChangeGaboEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
