...
import { OMNIDEF } from './paymentChangePaymentMethodEnglish_def.js';
import tmpl from './paymentChangePaymentMethodEnglish.html';
import tmpl_nds from './paymentChangePaymentMethodEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class paymentChangePaymentMethodEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
