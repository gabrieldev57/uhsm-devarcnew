...
import { OMNIDEF } from './individualAndFamilyPOCCFelipeEnglish_def.js';
import tmpl from './individualAndFamilyPOCCFelipeEnglish.html';
import tmpl_nds from './individualAndFamilyPOCCFelipeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualAndFamilyPOCCFelipeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
