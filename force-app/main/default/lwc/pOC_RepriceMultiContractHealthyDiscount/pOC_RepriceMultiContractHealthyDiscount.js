...
export default class POC_RepriceMultiContractHealthyDiscount extends OmniscriptBaseMixin(LightningElement) {
    @api reprice;
    @api beforereprice;
    @api discount;
    @api contractid;
                ...
                auxReprice.forEach(change => {
                    ...
                    const prom2 = new Promise((res, rej) => {
                        change.productList.forEach(prod => {
                            if (this.discount == true) {
                                prod.userInputs.forEach(userInputsItem => { 
                                    userInputsItem.healthyDiscount = true;
                                })
                            }
                    ...
                    prom2.then(() => {
                        ...
                        this.changesForContracts.push({
                            ...
                            contractCreated: LB_UserInputsItem.Id != null ? LB_UserInputsItem.Id : this.contractId,
                            ...
                            ContractId: LB_UserInputsItem.Id != null ? LB_UserInputsItem.Id : this.contractId,
                            Id: LB_UserInputsItem.Id != null ? LB_UserInputsItem.Id : this.contractId,
