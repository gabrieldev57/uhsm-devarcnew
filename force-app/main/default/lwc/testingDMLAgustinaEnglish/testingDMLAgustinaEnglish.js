...
import { OMNIDEF } from './testingDMLAgustinaEnglish_def.js';
import tmpl from './testingDMLAgustinaEnglish.html';
import tmpl_nds from './testingDMLAgustinaEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class testingDMLAgustinaEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
