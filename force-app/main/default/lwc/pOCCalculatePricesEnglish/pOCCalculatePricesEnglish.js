...
import { OMNIDEF } from './pOCCalculatePricesEnglish_def.js';
import tmpl from './pOCCalculatePricesEnglish.html';
import tmpl_nds from './pOCCalculatePricesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class pOCCalculatePricesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
