...
import { OMNIDEF } from './iFPEnrollmentApplicationEnglish_def.js';
import tmpl from './iFPEnrollmentApplicationEnglish.html';
import tmpl_nds from './iFPEnrollmentApplicationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class iFPEnrollmentApplicationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
