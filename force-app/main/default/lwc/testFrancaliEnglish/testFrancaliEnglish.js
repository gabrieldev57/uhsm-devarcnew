...
import { OMNIDEF } from './testFrancaliEnglish_def.js';
import tmpl from './testFrancaliEnglish.html';
import tmpl_nds from './testFrancaliEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class testFrancaliEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
