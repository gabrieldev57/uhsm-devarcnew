...
export default class aRC_MembersPlansTableV2 extends NavigationMixin(LightningElement) {
    @api recordId;
    ...
    async updateActiveInactiveDates() {
        ...
        console.log('Refactor data'+JSON.stringify(data));
		/* PROCESS INFO */
        ...
        for (let property in data[0]) {
            ...
            memberInfo.Id = (data[0][property])[0].ARC_PolicyParticipant__r.PrimaryParticipantContact.Account.Id;
            memberInfo.FullName = (data[0][property])[0].ARC_PolicyParticipant__r.PrimaryParticipantContact.Account.Name;
            ...
            // }
            memberInfo.Email = (data[0][property])[0].ARC_PolicyParticipant__r.PrimaryParticipantContact.Account.PersonEmail;
            memberInfo.SSN = (data[0][property])[0].ARC_PolicyParticipant__r.PrimaryParticipantContact.Account.vlocity_ins__SocialSecurityNumber__pc?.slice(-4);
            memberInfo.DOB =  (data[0][property])[0].ARC_PolicyParticipant__r.PrimaryParticipantContact.Account.PersonBirthdate;
            memberInfo.Age = (data[0][property])[0].ARC_PolicyParticipant__r.PrimaryParticipantContact.Account.vlocity_ins__Age__pc;
            memberInfo.isActive = (data[0][property])[0].ARC_PolicyParticipant__r.PrimaryParticipantContact.Account.IsActive;
            memberInfo.Relationship = (data[0][property])[0].ARC_PolicyParticipant__r.PrimaryParticipantContact.Account.ARC_DependentRelationship__c;
            ...
            data[0][property].forEach(plan => {
                ...
                planInfo.isActivePlan = plan.ARC_Policy__r.ARC_isActive__c;
