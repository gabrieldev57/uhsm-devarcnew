...
import { OMNIDEF } from './temporaryNewbornTOMASEnglish_def.js';
import tmpl from './temporaryNewbornTOMASEnglish.html';
import tmpl_nds from './temporaryNewbornTOMASEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class temporaryNewbornTOMASEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
