...
import { OMNIDEF } from './individualAndFamilyProgramChangeAncillaryNOTDSEnglish_def.js';
import tmpl from './individualAndFamilyProgramChangeAncillaryNOTDSEnglish.html';
import tmpl_nds from './individualAndFamilyProgramChangeAncillaryNOTDSEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualAndFamilyProgramChangeAncillaryNOTDSEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
