...
import { OMNIDEF } from './iFPEnrollmentPlanSelectionEnglish_def.js';
import tmpl from './iFPEnrollmentPlanSelectionEnglish.html';
import tmpl_nds from './iFPEnrollmentPlanSelectionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class iFPEnrollmentPlanSelectionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
