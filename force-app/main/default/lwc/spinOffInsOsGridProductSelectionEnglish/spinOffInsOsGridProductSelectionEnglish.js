...
import { OMNIDEF } from './spinOffInsOsGridProductSelectionEnglish_def.js';
import tmpl from './spinOffInsOsGridProductSelectionEnglish.html';
import tmpl_nds from './spinOffInsOsGridProductSelectionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class spinOffInsOsGridProductSelectionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
