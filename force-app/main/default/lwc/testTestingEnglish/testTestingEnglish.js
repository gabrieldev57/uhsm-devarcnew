...
import { OMNIDEF } from './testTestingEnglish_def.js';
import tmpl from './testTestingEnglish.html';
import tmpl_nds from './testTestingEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class testTestingEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
