...
import { OMNIDEF } from './individualAndFamilyProgramCancellationEnglish_def.js';
import tmpl from './individualAndFamilyProgramCancellationEnglish.html';
import tmpl_nds from './individualAndFamilyProgramCancellationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualAndFamilyProgramCancellationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
