...
import { OMNIDEF } from './demoCensusUploadEnglish_def.js';
import tmpl from './demoCensusUploadEnglish.html';
import tmpl_nds from './demoCensusUploadEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class demoCensusUploadEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
