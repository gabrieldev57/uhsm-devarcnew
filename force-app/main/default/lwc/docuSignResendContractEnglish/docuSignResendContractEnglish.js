...
import { OMNIDEF } from './docuSignResendContractEnglish_def.js';
import tmpl from './docuSignResendContractEnglish.html';
import tmpl_nds from './docuSignResendContractEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class docuSignResendContractEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
