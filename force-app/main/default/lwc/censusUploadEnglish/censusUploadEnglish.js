...
import { OMNIDEF } from './censusUploadEnglish_def.js';
import tmpl from './censusUploadEnglish.html';
import tmpl_nds from './censusUploadEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class censusUploadEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
