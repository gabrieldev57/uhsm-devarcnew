...
import { OMNIDEF } from './cancellationConfirmationPageEnglish_def.js';
import tmpl from './cancellationConfirmationPageEnglish.html';
import tmpl_nds from './cancellationConfirmationPageEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cancellationConfirmationPageEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
