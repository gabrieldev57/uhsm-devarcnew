...
import { OMNIDEF } from './programChangeEffectiveDateEnglish_def.js';
import tmpl from './programChangeEffectiveDateEnglish.html';
import tmpl_nds from './programChangeEffectiveDateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class programChangeEffectiveDateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
