...
import { OMNIDEF } from './addChargeEnglish_def.js';
import tmpl from './addChargeEnglish.html';
import tmpl_nds from './addChargeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class addChargeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
