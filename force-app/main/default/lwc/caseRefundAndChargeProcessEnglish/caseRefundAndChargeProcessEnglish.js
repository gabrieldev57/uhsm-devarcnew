...
import { OMNIDEF } from './caseRefundAndChargeProcessEnglish_def.js';
import tmpl from './caseRefundAndChargeProcessEnglish.html';
import tmpl_nds from './caseRefundAndChargeProcessEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class caseRefundAndChargeProcessEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
