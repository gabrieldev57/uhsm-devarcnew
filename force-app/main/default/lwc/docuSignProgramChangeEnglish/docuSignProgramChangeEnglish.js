...
import { OMNIDEF } from './docuSignProgramChangeEnglish_def.js';
import tmpl from './docuSignProgramChangeEnglish.html';
import tmpl_nds from './docuSignProgramChangeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class docuSignProgramChangeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
