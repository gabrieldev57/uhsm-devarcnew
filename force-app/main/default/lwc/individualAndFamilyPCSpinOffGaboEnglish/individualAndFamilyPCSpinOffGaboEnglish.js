...
import { OMNIDEF } from './individualAndFamilyPCSpinOffGaboEnglish_def.js';
import tmpl from './individualAndFamilyPCSpinOffGaboEnglish.html';
import tmpl_nds from './individualAndFamilyPCSpinOffGaboEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualAndFamilyPCSpinOffGaboEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
